  ...
  const handleSendMessage = async (e) => {
    try {
      ...
      const response = await axios.post(
        "https://backend-hdll.onrender.com/api/v1/message/send",
        {
          name,
          email,
          subject,
      ...
      if (response && response.data) {
        ...
        // Handle the case where the response or its data property is undefined
        console.error('Response or data property is undefined');
      }
    } catch (error) {
